...
function toggleDetails(btn) {
    var projectDetails = btn.parentNode.nextElementSibling.querySelector('.project-detail');
...
var link = document.getElementById("hire-me-link");
...
document.getElementById("hire-me-form").addEventListener("submit", function(event) {
  ...
  // Handle form submission (e.g., send AJAX request)
  // Display a confirmation message to the user
  var formData = new FormData(this);

      // Construct email body
      var emailBody = "Email: " + formData.get('email') + "\n\n" + "Message:\n" + formData.get('message');

      // Send email using mailto link
      window.location.href = "mailto:pratigyapaudel0@gmail.com?subject=Contact%20Form&body=" + encodeURIComponent(emailBody);
